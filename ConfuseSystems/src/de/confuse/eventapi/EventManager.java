...
{
	/**
	 * Contains all of the currently registered classes with their respective
	 * methods.<br>
	 ...
	 */
	private static final Map<Class<? extends IEvent>, List<MethodData>> REGISTRY_MAP = new HashMap<Class<? extends IEvent>, List<MethodData>>();
	...
	public static void unregister(Object object)
	{
		for (final List<MethodData> dataList : REGISTRY_MAP.values())
			for (final MethodData data : dataList)
				if (data.getObject().equals(object))
					dataList.remove(data);

		cleanMap(true);
	}

	public static final IEvent call(final IEvent event)
	{
	...
	private final static class MethodData
	{
		 ...
		 * method of a specific object. All of the Methods added here have to be annoted
